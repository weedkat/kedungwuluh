...
class CreateSuratPengantarUmumTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_surat_pengantar_umum', function (Blueprint $table) {
            $table->id('id');
    ...
    {
        Schema::dropIfExists('_surat_pengantar_umum');
    }
}
