...
class CreateSuratPengantarCatatanKepolisianTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_surat_pengantar_catatan_kepolisian', function (Blueprint $table) {
            $table->id('id');
    ...
    {
        Schema::dropIfExists('_surat_pengantar_catatan_kepolisian');
    }
}
